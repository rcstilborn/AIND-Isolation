...
class ParameterizedEvaluationFunction:
    ...
    Parameters
    ----------
    weights : [] - list of 6 integer values
    ...
    def eval_func(self, game, player):
        """Calculate the heuristic value of a game state from the point of view
        of the given player.  Uses the parameters provided in weights[]
        ...
        if game.move_count < ((game.height * game.width)/2):
            ...
            return float(self.weights[3] * own_moves - 
                         ...
                         self.weights[5] * __distance_from_center__(game, player))
